...
)  # First alias (value to store in the database) and name (value to show the user) for each lexer
STYLE_CHOICES = sorted([(item, item) for item in get_all_styles()])


class Snippet(models.Model):
    created: models.DateTimeField = models.DateTimeField(auto_now_add=True)
    title: models.CharField = models.CharField(max_length=100, blank=True, default="")
    ...
    highlighted: models.TextField = models.TextField()
